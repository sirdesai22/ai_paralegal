...
export default function App({ children }: { children: React.ReactNode }) {
  ...
  const menuItems = [
    ...
    // },
    {
      ...
      icon: FileText,
      view: "/dashboard/analysis" as ViewType,
    },
    {
      title: "Your Documents",
      icon: FolderOpen,
      view: "/dashboard/your-documents" as ViewType,
    },
    {
      title: "Legal Research",
      icon: BookOpen,
      view: "/dashboard/research" as ViewType,
    },
    {
      title: "Task Manager",
      icon: CheckSquare,
      view: "/dashboard/tasks" as ViewType,
    },
    {
      title: "Calendar",
      icon: Calendar,
      view: "/dashboard/calendar" as ViewType,
    },
  ];
