...
I will give you a legal document which will be uploaded/attached and sent to you. The document can be either a Law or related Legal Document containing law/rules and regulations etc, OR it can be a Legal Case / dispute between two parties. You need to analyze this document and do the following:
